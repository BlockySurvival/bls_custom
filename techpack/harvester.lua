...
if minetest.get_modpath("cucina_vegana") then
    fn("cucina_vegana:parsley_5", "cucina_vegana:parsley 4", "cucina_vegana:parsley_1")
    fn("cucina_vegana:rosemary_6", "cucina_vegana:rosemary 4", "cucina_vegana:rosemary_1")
    fn("cucina_vegana:chives_5", "cucina_vegana:chives 4", "cucina_vegana:chives_1")
    fn("cucina_vegana:flax_6", "cucina_vegana:flax_raw 4", "cucina_vegana:flax_1")
