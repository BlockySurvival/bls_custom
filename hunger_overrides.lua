...
if get_modpath('extra') then
    set_eat('extra:tequila', 1, bottle)
    set_eat('extra:rum', 1, bottle)
    ...
    set_eat('extra:ground_meat', 1)
    set_eat('extra:meat_patty', 1)
    ...
    set_eat('extra:super_taco', 3)
    set_eat('extra:quesadilla', 2)
    set_eat('extra:pasta', 0)
    set_eat('extra:pepperoni', 5)
    set_eat('extra:garlic_bread', 2)
    set_eat('extra:marinara', 2)
    set_eat('extra:spaghetti', 2)
    set_eat('extra:lasagna', 3)
    set_eat('extra:cheese_pizza', 2)
...
if get_modpath('farming') then
    ...
    set_eat('farming:beetroot_soup', 6, bowl)
