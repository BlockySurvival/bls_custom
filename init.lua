...
dofile(bls.modpath .. "/custom_items/message_block.lua")
...
dofile(bls.modpath .. "/commands/list_player_areas.lua")
...
dofile(bls.modpath .. "/privs/nic.lua")
...
dofile(bls.modpath .. "/techpack/digilines.lua")
dofile(bls.modpath .. "/terumet/alloy_smelter.lua")
dofile(bls.modpath .. "/terumet/disable_particles.lua")
